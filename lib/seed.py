...
if __name__ == "__main__":
    ...
    big_zombie = Zombie(description="Big and brute",
                        health=40, location=graveyard)
    small_zombie = Zombie(description="Small", health=8,
    ...
    hand_gun = Weapon(damage=10)
    rifle = Weapon(damage=20)
    shotgun = Weapon(damage=40)

    session.add_all([hand_gun, rifle, shotgun])
